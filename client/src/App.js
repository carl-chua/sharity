...
class App extends Component {
  state = { web3: null, accounts: null, charityContract: null, donationContract: null };
  ...
  componentDidMount = async () => {
    try {
      ...
      this.setState({ web3, accounts, charityContract: charityInstance, donationContract: donationInstance });
    } catch (error) {
